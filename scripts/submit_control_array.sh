...
RESULTS_DIR="${RESULTS_DIR:-runs/control_hpc}"
MATRIX="${MATRIX:-$PROJECT_DIR/runs/control_matrix.jsonl}"
SLURM_SCRIPT="${SLURM_SCRIPT:-$PROJECT_DIR/scripts/control_array.slurm}"
